...
CREATE TABLE {$db_prefix}member_roles (
    id int(11) NOT NULL AUTO_INCREMENT,
    id_member int(11) NOT NULL,
...
#
# Table structure for table `smerit_max`
#

CREATE TABLE {$db_prefix}smerit_max (
  id int(11) NOT NULL AUTO_INCREMENT,
  merit_max_limit int(11) NOT NULL DEFAULT '0',
  PRIMARY KEY (id)
) ENGINE={$engine};
...
#
# Table structure for table `smerit_logs`
#
